...
<body>
    ...
    <div class="card"></div>
    <div>
        <div class="header-dark" style="background-image: url(&quot;assets/img/black.jpg&quot;);background-repeat: no-repeat;background-size: cover;background-position: center;">
    ...
    <div class="highlight-blue" style="background-color: #585858;">
        <div class="container-fluid">
            <div class="intro">
                <h2 class="text-uppercase text-center">RDA ADMINSTRATION<img src="assets/img/sri-lanka-map.jpg" loading="eager" width="80px"></h2>
            </div>
        </div>
    </div>
