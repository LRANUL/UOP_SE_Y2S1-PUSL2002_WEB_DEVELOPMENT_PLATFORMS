  ...
  */
          ...
          <div>
                    ...
                    <div class="card" style="width: 100%; height: 340px; border: 0.5px solid #82DAFE; border-radius: 10px;">
                      <div class="card-body">
                        ...
                        <div style="margin-left: 20px; margin-top: -20px;">
                          ...
                          <button type="button" onclick="updateStatusApprove()" class="btn btn-outline-primary" style="width: 120px;"> <b>Approve</b>
                          </button>
            ...
            <div style="height: 135px;
              ...
              <div style="margin-left: 20px;
                          margin-top: 50px;
                          text-align: center;">
                <img src="importantReports.png" style="display: inline-block;
                                                      position: relative;
                                                      left: 100px;
                                                      bottom: 40px;">
                  <p style="display: inline-block;">Severity: 3 Reports</p>
                <img src="approvedReports.png" style="display: inline-block;
                                                      position: relative;
                                                      left: 90px;
                                                      bottom: 40px;">
                  <p style="display: inline-block;">Approved Reports</p>
                <img src="helpSentReport.png" style="display: inline-block;
                                                      position: relative;
                                                      left: 100px;
                                                      bottom: 40px;">
                  <p style="display: inline-block;">Help Sent Reports</p>
                <img src="pendingReports.png" style="display: inline-block;
                                                     position: relative;
                                                     left: 80px;
                                                     bottom: 40px;" height="50px" width="35px">
                  <p style="display: inline-block;">Pending Reports</p>
                <img src="completedReport.png" style="display: inline-block;
                                                      position: relative;
                                                      left: 90px;
                                                      bottom: 40px;">
                  <p style="display: inline-block;">Completed Reports</p>
                <img src="disapprovedReports.png" style="display: inline-block;
                                                         position: relative;
                                                         left: 95px;
                                                         bottom: 40px;">
    ...
    <script>
      function updateStatusApprove(){
        <?php
        $updateStatusSQL = "UPDATE report SET Status = 'Approved' WHERE ID = '$reportReportID';";
