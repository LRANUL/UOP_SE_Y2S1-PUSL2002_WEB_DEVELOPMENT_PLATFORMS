<%@ Page Language="C#" AutoEventWireup="true" CodeFile="index.aspx.cs" Inherits="RDA" %>
            ...
            <div class="header-blue">
                <nav class="navbar navbar-light navbar-expand-md navigation-clean-search">
                    <div class="container-fluid">
                        <a class="navbar-brand" href="index.aspx">Road Development Authority</a>
                        <button id="drop" data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span>
                        ...
                        <div
                            ...
                            <span class="navbar-text"><a class="login" href="Login.aspx">Log In</a></span>
                            <a class="btn btn-light action-button" role="button" href="Signup.aspx">Sign Up</a>
                        </div>
                    </div>
                </nav>
                <div class="container hero">
                    <div class="row">
                        <div class="col-12 col-lg-6 col-xl-5 offset-xl-1">
                            <h1 data-bs-hover-animate="flash">The revolution is here.</h1>
                            <p>Sri Lankan's Largest Accident Management and Reporting Community !</p>
                            <button class="btn btn-light btn-lg action-button" data-bs-hover-animate="pulse" type="button">Learn More</button>
                        </div>
                        <div class="col-md-5 col-lg-5 offset-lg-1 offset-xl-0 d-none d-lg-block phone-holder"
                            data-bs-hover-animate="pulse">
                            <div class="iphone-mockup">
                                <img class="device" src="assets/img/iphone.svg">
                                <div class="screen" style="background-image: url(&quot;assets/img/sri-lanka_map.png&quot;);"></div>
                            </div>
                        </div>
                    </div>
                </div>
