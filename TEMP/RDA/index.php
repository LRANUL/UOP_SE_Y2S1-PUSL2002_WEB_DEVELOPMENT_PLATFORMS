...
<head>
    ...
    <title>RDA Accident Assistance</title>
        ...
        <div class="container hero">
            <div class="row">
                <div class="col-12 col-lg-6 col-xl-5 offset-xl-1">
                    ...
                    <p>Sri Lankan's Largest Accident Management and Reporting Community !</p><button class="btn btn-light btn-lg action-button" data-bs-hover-animate="pulse" type="button">Learn More</button></div>
